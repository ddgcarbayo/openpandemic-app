...
class ConditionsUsePage extends LitElement {
  ...
  _getContent() {
    fetch('data/pages/conditions-use-page.json').then(res => res.json()).then(content => {
...
customElements.define('conditions-use-page', ConditionsUsePage);
